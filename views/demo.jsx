    ...
    const micBullet =
      typeof window !== "undefined" && recognizeMicrophone.isSupported ? (
        <li className="base--li">
          Usa tu micrófono para grabar audio. Para obtener mejores resultados,
          utilice la banda ancha modelos de entrada de micrófono.
        </li>
      ) : (
        <li className="base--li base--p_light">
          usa tu microfono apra grabar el audio. (Not supported in current
          browser)
        </li>
      ); // eslint-disable-line
      ...
      >
        <div className="drop-info-container">
          <div className="drop-info">
            <h1>Suelta un archivo de audio aquí.</h1>
            <p>
              Watson Speech to Text soporta .mp3, .mpeg, .wav, .opus, y .flac
              archivos de hasta 200mb.
            </p>
          </div>
        </div>

        <h1 className="">Texto a Audio con watson IBM</h1>

        <ul className="base-ul">
          {micBullet}
          <li className="base-li">
            Sube el audio pregrabado (.mp3, .mpeg, .wav, .flac, o .opus
            solamente).
          </li>
          <li className="base--li">
            Reproducir uno de los archivos de audio de muestra.*
          </li>
        </ul>

        <div className="smalltext">
          *Ambos archivos de audio de muestra de banda ancha en inglés de EE.UU.
          están cubiertos por el Licencia Creative Commons.
        </div>
        ...
        >
          El resultado devuelto incluye el texto reconocido,{" "}
          <a
            className="base--a"
        ...
        <div className="flex buttons">
          ...
          >
            <Icon type={audioSource === "sample-1" ? "stop" : "play"} /> ejemplo
            1
          </button>
          ...
          >
            <Icon type={audioSource === "sample-2" ? "stop" : "play"} /> ejemplo
            2
          </button>
        </div>
        ...
        <Tabs selected={0}>
          ...
          <Pane label="Palabras y alternativas">
